...
public class ErrorInterceptor implements HandlerInterceptor {
	 ...
	 */
	@Override
	public void postHandle(HttpServletRequest req, HttpServletResponse response, Object arg2, ModelAndView modelAndView)
			throws Exception {
		// TODO Auto-generated method stub
		if (response.getStatus() == 405 || response.getStatus() == 500) {
